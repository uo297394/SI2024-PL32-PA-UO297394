...
public class InscripcionesController {
	private InscripcionesModel model;
	private InscripcionesView view;
	private String lastSelectedKey=""; //recuerda la ultima fila seleccionada para restaurarla cuando cambie la tabla de carreras

	public InscripcionesController(InscripcionesModel m, InscripcionesView v) {
		this.model = m;
		this.view = v;
	...
	public void getListaCarreras() {
		List<InscripcionesDisplayDTO> carreras=model.getListaInscripciones(Util.isoStringToDate(view.getFechaHoy()));
		TableModel tmodel=SwingUtil.getTableModelFromPojos(carreras, new String[] {"id", "nombreColegiado", "apellidoColegiado", "tituloCurso", "fechaInscripcion"});
		...
		List<Object[]> carrerasList=model.getListaInscripcionesArray(Util.isoStringToDate(view.getFechaHoy()));
	...
	public void updateDetail() {
		...
		InscripcionesEntity inscripcion=model.getInscripcion(idCarrera);
		TableModel tmodel=SwingUtil.getRecordModelFromPojo(inscripcion, new String[] {"id", "idColegiado", "idCurso", "fechaInscripcion"});
