...
create table Recibos(id int auto_increment primary key, idColegiado int,cuota double, estado enum, año_emitido int, fecha_pagado date, fecha_devuelto date, FOREIGN KEY (idColegiado) REFERENCES Colegiados(id));
