...
INSERT INTO Colegiados (id, nombre, apellido, DNI, direccion, fecha_nacimiento, numero_cuenta, banco, precolegiados, estado_solicitud, fecha_solicitud)
VALUES 
(1, 'Juan', 'Pérez', '12345678A', 'Calle Falsa 123', '1985-04-23', 987654321, 'Banco1', FALSE, 'aprobado', '2024-01-10'),
(2, 'María', 'Gómez', '87654321B', 'Avenida Siempre Viva', '1990-07-15', 123456789, 'Banco2', TRUE, 'pendiente', '2024-02-05'),
(3, 'Carlos', 'López', '11223344C', 'Plaza Mayor 5', '1982-12-01', 111222333, 'Banco3', FALSE, 'rechazado', '2024-03-12'),
(4, 'Ana', 'Fernández', '44332211D', 'Calle Luna 8', '1995-09-30', 444555666, 'Banco1', TRUE, 'aprobado', '2024-04-20'),
(5, 'Luis', 'Martínez', '66778899E', 'Camino del Sol 21', '1988-06-14', 777888999, 'Banco2', FALSE, 'pendiente', '2024-05-25');
